...
<div class="wrapper fadeInDown">
    <div id="formContent">
        ...
        <form action="{{\Illuminate\Support\Facades\URL::to('/login')}}" method="POST">
            ...
            <div>
                <input style="magin" class="form-check-input" type="checkbox"> Ghi nhớ
            </div>
        ...
        <!-- Remind Passowrd -->
        <div id="formFooter">
            <a style="margin-left: 70px" class="underlineHover" href="register">Register</a>
            <a style="margin-right:70px" class="underlineHover" href="#">Forgot Password?</a>
        </div>
